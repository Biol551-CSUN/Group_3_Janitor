...
* #### **adorn_ns(position = "...")**
  ...
  +  Ns can be positioned in the front or in the rear end of the percentage, showing how mnay times that
  percentage was brought up
  for that actegory on that date.
...
drugs %>%
  ...
  adorn_ns("rear")%>% # can be moved to the front or the back of the percentage, shows you how many times that actegory was brought up on that date
